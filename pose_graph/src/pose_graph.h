...
#include <auv_nav_msg/AlterMag.h>
...
#define FRAME_NUM 25//10////tank1 10//field 25 //tank2 15
#define THRE_IMG  0.032//mvis 0.008//tank2 0.012//0.03//tank1 0.016//field0.032//tank2 0.011
...
struct FrameInfo
{
	...
	// double prepare_time;
	double query_time;
	double add_frame_time;
	std::vector<double> connect_time;
	double recent_opt_time;
	int opt_count;
	int feature_num;
	int connect_num;
	int connect_count;
	// double show_time;
	double add_descriptor_time;
	double debug_img_time;
	bool flag_detect;
	bool flag_connect;
...
private:
	int detectLoop(KeyFrame* keyframe, int frame_index, auv_nav_msg::DetectLoop& detect_loop_msg);
