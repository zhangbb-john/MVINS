...
cd /home/ubuntu/VINS-Mono-Benchmark/src/vins-mono-benchmark; cd ../../; source ./devel/setup.bash;roslaunch vins_estimator underwater_cave.launch|tee ~/VINS-Mono-Benchmark/vins.txt&& read -p PressEnter&& sleep 100;
 exec bash "';
sleep 5;
